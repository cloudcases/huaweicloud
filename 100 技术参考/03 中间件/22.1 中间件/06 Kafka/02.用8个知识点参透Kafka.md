...
[![img](https://upload.jianshu.io/users/upload_avatars/24630328/546993c0-13c6-4d88-8220-3190e35b9ef2.png?imageMogr2/auto-orient/strip|imageView2/1/w/96/h/96/format/webp)](https://www.jianshu.com/u/ec711df8359d)

[架构师小麒](https://www.jianshu.com/u/ec711df8359d)[![  ](https://upload.jianshu.io/user_badge/7220f8ab-64d9-4474-bfbc-a387c4ee5437)](https://www.jianshu.com/mobile/campaign/day_by_day/join?utm_medium=badge)关注

0.1922021.05.20 14:53:07字数 4,254阅读 782

# **Kafka的基本介绍**

Kafka是最初由Linkedin公司开发，是一个分布式、分区的、多副本的、多订阅者，基于zookeeper协调的分布式日志系统（也可以当做MQ系统），常见可以用于web/nginx日志、访问日志，消息服务等等，Linkedin于2010年贡献给了Apache基金会并成为顶级开源项目，[Java核心学习笔记](https://links.jianshu.com/go?to=https%3A%2F%2Fmp.weixin.qq.com%2Fs%2FAgJ9iymCiM63a9E20mlA6Q)分享。

![img](https://upload-images.jianshu.io/upload_images/24630328-960a83485d92523c.png?imageMogr2/auto-orient/strip|imageView2/2/w/975/format/webp)
...
![img](https://upload-images.jianshu.io/upload_images/24630328-c3b394cb52d7bbe6.png?imageMogr2/auto-orient/strip|imageView2/2/w/1200/format/webp)
...
![img](https://upload-images.jianshu.io/upload_images/24630328-4b4f0ed50bf6f05d.png?imageMogr2/auto-orient/strip|imageView2/2/w/928/format/webp)

在Kafka文件存储中，同一个topic下有多个不同partition，每个partition为一个目录，partiton命名规则为topic名称+有序序号，第一个partiton序号从0开始，序号最大值为partitions数量减1。

![img](https://upload-images.jianshu.io/upload_images/24630328-735fe624db602b51.png?imageMogr2/auto-orient/strip|imageView2/2/w/702/format/webp)
...
![img](https://upload-images.jianshu.io/upload_images/24630328-1a6b00032bacab6d.png?imageMogr2/auto-orient/strip|imageView2/2/w/282/format/webp)

segment中index与data file对应关系物理结构如下：

![img](https://upload-images.jianshu.io/upload_images/24630328-e02e68271487ba2f.png?imageMogr2/auto-orient/strip|imageView2/2/w/552/format/webp)
...
![img](https://upload-images.jianshu.io/upload_images/24630328-ff91ebe8bc14c128.png?imageMogr2/auto-orient/strip|imageView2/2/w/204/format/webp)
...
![img](https://upload-images.jianshu.io/upload_images/24630328-6587595442ccff9f.png?imageMogr2/auto-orient/strip|imageView2/2/w/506/format/webp)
...
![img](https://upload-images.jianshu.io/upload_images/24630328-573506a7072d2841.png?imageMogr2/auto-orient/strip|imageView2/2/w/633/format/webp)
...
![img](https://upload-images.jianshu.io/upload_images/24630328-2571cf8b047d0979.png?imageMogr2/auto-orient/strip|imageView2/2/w/1010/format/webp)
...
![img](https://upload-images.jianshu.io/upload_images/24630328-3f5154b636b963c9.png?imageMogr2/auto-orient/strip|imageView2/2/w/800/format/webp)
...
![img](https://upload-images.jianshu.io/upload_images/24630328-7e3b4b4b5259fbd6.png?imageMogr2/auto-orient/strip|imageView2/2/w/600/format/webp)

对于传统的message queue而言，一般会删除已经被消费的消息，而Kafka是不会删除数据的，它会把所有的数据都保留下来，每个消费者（Consumer）对每个Topic都有一个offset用来表示读取到了第几条数据。

![img](https://upload-images.jianshu.io/upload_images/24630328-be483b797f5d2f71.png?imageMogr2/auto-orient/strip|imageView2/2/w/519/format/webp)
...
![img](https://upload-images.jianshu.io/upload_images/24630328-7076a3c1fad87641.png?imageMogr2/auto-orient/strip|imageView2/2/w/350/format/webp)
...
![img](https://upload-images.jianshu.io/upload_images/24630328-7d25f2df1ef83d4f.png?imageMogr2/auto-orient/strip|imageView2/2/w/476/format/webp)

先复制到内核空间（read是系统调用，放到了DMA，所以用内核空间），然后复制到用户空间（1、2）；从用户空间重新复制到内核空间（你用的socket是系统调用，所以它也有自己的内核空间），最后发送给网卡（3、4）。

![img](https://upload-images.jianshu.io/upload_images/24630328-ae2d186eff7248f2.png?imageMogr2/auto-orient/strip|imageView2/2/w/350/format/webp)

Zero Copy中直接从内核空间（DMA的）到内核空间（Socket的），然后发送网卡。这个技术非常普遍，Nginx也是用的这种技术。

实际上，Kafka把所有的消息都存放在一个一个的文件中，当消费者需要数据的时候Kafka直接把“文件”发送给消费者。[Java中间件面试题 +学习笔记](https://links.jianshu.com/go?to=https%3A%2F%2Fmp.weixin.qq.com%2Fs%2FoVDE6zNpxfBaWcus63wWeg)，当不需要把整个文件发出去的时候，Kafka通过调用Zero Copy的sendfile这个函数，这个函数包括：
...
https://www.jianshu.com/p/e55121d23400